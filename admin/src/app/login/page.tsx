        ...
        <div className="w-full max-w-[480px] animate-fade-in">
          ...
          <div className="auth-saas-card">
            <div className="mb-10 text-center">
              ...
              <h1 className="text-3xl font-black text-white mb-2 tracking-tight italic">Acceso Seguro</h1>
            ...
            <div className="mt-8 pt-8 border-t border-white/5 space-y-4">
              ...
              <Link href="/register" className="w-full flex items-center justify-center h-12 rounded-xl border border-white/10 text-white font-bold text-sm hover:bg-white/5 transition-all">
          ...
          <div className="mt-10 flex items-center justify-center gap-6 text-slate-500">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest">Proyecto Ferias 2026</span>
          </div>
        </div>
      </main>
    </div>
